...
$transaksi = mysqli_query($conn, "SELECT * FROM pengiriman");
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-red elevation-4">
    ...
    <a href="index.php" class="brand-link navbar-red">
      <img src="dist/img/AdminLTELogo.png" class="brand-image " >
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="daftarproduk.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="manageuser.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
